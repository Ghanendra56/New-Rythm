...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    if (user) {
      ...
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=933729834901860382&permissions=8&scope=bot")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://dsc.gg/syntaxerrorthedev")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(client.getFooter(`${user.username} | powered by Syntax Codes Inc.`, "https://cdn.discordapp.com/icons/950734695346348113/8c0af73c4448d0ca77d0720a050c9761.webp?size=1024"))
        ],
